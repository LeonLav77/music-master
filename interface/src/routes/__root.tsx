...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Touch-first web control surface for the BOSS Katana MkII amplifier." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Katana MkII Control Surface" },
      { property: "og:description", content: "Touch-first web control surface for the BOSS Katana MkII amplifier." },
